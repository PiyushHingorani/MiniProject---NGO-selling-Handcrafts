...
?>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      <h1>Zimcrafts - Artists Online Handicraft Store..</h1>
      ...
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            <p class="font-italic"><b>Welcome to our Online Handicraft Store!</b>
              <br>At Zimcrafts, we believe that art has the power to inspire, transform, and connect people from all walks of life. We have created a vibrant online marketplace where artists can showcase their talent, and art enthusiasts can discover and collect captivating artworks from around the world.
            </p>
            ...
            <ul>
              <li><i class="ri-check-double-line"></i> ‘Zimcrafts' is a model Artists management website application..</li>
              <li><i class="ri-check-double-line"></i> ‘Zimcrafts’ provides a concept of virtual art trade to its users.</li>
              ...
              <div class="row">
                ...
                <div class="col-xl-4 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <p>Online Market where you can Sell all your artworks...<br>
