...
<head>
  ...
  <title>Zimcrafts - Online Handicraft Store</title>
  <meta content="description" name="An Online Handicraft Store is a digital marketplace that connects artists, collectors, and art enthusiasts for the purpose of buying and selling artworks.">
    ...
    <div class="container">
      <div class="header-container d-flex align-items-center">
        <div class="logo mr-auto">
          <h1 class="text-light"><a href="index.php"><span>ZIMCRAFTS</span></a></h1>
...
<li class="drop-down <?php
  ...
  <ul>
	...
	<li class="drop-down"><a href="#">Crafts</a>
	  <ul>
			<li><a href="Product.php">Put Your Crafts On Sale</a></li>
			<li><a href="viewProduct.php">View Your Crafts On Sale</a></li>
	  </ul>
	</li>
